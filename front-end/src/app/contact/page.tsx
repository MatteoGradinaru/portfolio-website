...
export default function Contact() {
  return (
    <section className="section" style={{ textAlign: "left", maxWidth: "800px", padding: "40px 0" }}>
      <h2 className="section-title" style={{ color: "var(--heading-color)", marginBottom: "20px" }}>Let's Connect</h2>
      <p style={{ marginBottom: "40px", fontSize: "1.1rem", lineHeight: "1.6", color: "var(--text-color, #555)" }}>
